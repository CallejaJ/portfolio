...
export const translations = {
  es: {
    ...
    heroCompare: {
      beforeLabel: "Antes — web en serie",
      afterLabel: "Después — web que vende",
      url: "tunegocio.es",
      beforeScore: "42/100",
      afterScore: "99/100",
      beforeCta: "Contactar",
    ...
    analyzer: {
      ...
      analyzingSub: "Esto tarda unos segundos, lo hace Google.",
      errorInvalid: "Escribe una dirección de web válida (ej. tu-negocio.es).",
      errorFailed:
        "No pude analizar esa web. Comprueba la dirección o mándamela por WhatsApp y la reviso yo.",
      scoreLabels: {
      ...
      checksTitle: "Comprobaciones básicas",
      resultBad: "Tu web tiene margen de mejora. Y eso te está costando clientes.",
      resultOk: "No está mal. Pero casi siempre se puede exprimir más.",
      resultGood: "¡Enhorabuena! Tu web va muy bien. Si quieres, la afino aún más.",
  ...
  en: {
    ...
    heroCompare: {
      beforeLabel: "Before — cookie-cutter site",
      afterLabel: "After — a site that sells",
      url: "yourbusiness.es",
      beforeScore: "42/100",
      afterScore: "99/100",
      beforeCta: "Contact",
    ...
    analyzer: {
      ...
      analyzingSub: "This takes a few seconds — Google does it.",
      errorInvalid: "Type a valid website address (e.g. your-business.com).",
      errorFailed:
        "I couldn't analyze that website. Check the address or send it to me on WhatsApp and I'll review it.",
      scoreLabels: {
        rendimiento: "Speed",
      ...
      checksTitle: "Basic checks",
      resultBad: "Your website has room to improve. And that's costing you clients.",
      resultOk: "Not bad. But there's almost always more to squeeze out.",
      resultGood: "Congrats! Your website is doing great. I can fine-tune it further if you want.",
